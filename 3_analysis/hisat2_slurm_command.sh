...
-1 /project/newc6434/linux/2_rnaseq/1_fastq/fastq_link/cd4_rep1_read1.fastq.gz \
-2 /project/newc6434/linux/2_rnaseq/1_fastq/fastq_link/cd4_rep1_read2.fastq.gz \
--rna-strandness RF \
