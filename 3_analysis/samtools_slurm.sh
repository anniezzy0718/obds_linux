...
samtools view --threads 8 -b aln-pe.sam > aln-pe.bam &&
samtools sort --threads 8 aln-pe.bam > sorted_aln-pe.bam &&
samtools index --threads 8 sorted_aln-pe.bam &&
samtools flagstat --threads 8 sorted_aln-pe.bam > aln-pe.flagstat &&
samtools idxstats --threads 8 sorted_aln-pe.bam > aln-pe.idxstats
